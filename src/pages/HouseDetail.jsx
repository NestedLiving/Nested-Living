                        ...
                        <div className="col-md-6">
                            ...
                            {currentUser && house.owner === currentUser.id && (
                                <div className="btn-container">
                                    ...
                                    <Link to={`/houses/${id}/delete`} onClick={onDelete} className="btn btn-danger">Delete</Link>
                                </div>
                            )}
...
import { faEuroSign, faMapMarkerAlt, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div>
                            ...
                            <div className="col-md-6">
                                <div className="bg-light p-3 rounded shadow-lg">
                                    ...
                                    <div className="flex items-center text-gray-700">
                                        ...
                                        <p>Available from: {formatDate(house.startDate)} to {formatDate(house.endDate)}</p>
                                    </div>
                                    <div className="mt-4">
                        ...
                        <div className="row mt-5">
                            <div className="col-md-6">
                                ...
                                <div className="col-md-6">
                                    <div className="bg-light p-3 rounded reservation-form-container">
                                        <h3>Reservation</h3>
                                        <ReservationForm houseId={id} />
                                    </div>
                                </div>
